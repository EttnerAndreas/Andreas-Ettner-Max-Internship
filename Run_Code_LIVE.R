...
n= 100
glm1 <- glmmTMB(my.data$y ~ ar1(times + 0 | group), data=data)
?glmmTMB
...
min(res) # 57.61983 = 0.16 best score
ll(c(0.01, 0.0))
ll(c(0.16, 0.0))
...
lambda_plot1
matplot(data ~ lambda_plot1 ,xlim = c("lamda0.2", "lamda0.4", "lamda0.6","lamda0.8", "lamda1.0", "lamda1.2", "lamda1.4", "lamda1.6", "lamda1.8", "lamda2.0")) 
ploteins <- plot(data ~ lambda_plot1 ,xlim = c(0.2,2.0),ylab= "rmse true lambda  vs  estimated L", xlab = "lambda 0.2 bis 2.0", par(bg="white",fg="red",pch=16) )


loop$Side[sid4]
sid4 <- rmse(loop$Lambda[c(81:90, 181:190, 281:290, 381:390, 481:490 )], repeat.experiment$glmm_Lambda[c(81:90, 181:190, 281:290, 381:390, 481:490 )]))

sid4  <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)
sid6  <- c(2,12,22,32,42,52,62,72,82,92,102,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)
sid8  <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)
sid10 <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)
sid12 <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)
sid14 <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)
sid16 <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)
sid18 <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)
sid20 <- c(1,11,21,31,41,51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211,221,231,241,251,261,271,281,291,301,311,321,331,341,351,361,371,381,391,401,411,421,431,441,451,461,471,481,491)

n = 0
test <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)

n = 0
sid4 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 1
sid6 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 2
sid8 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 3
sid10 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 4
sid12 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 5
sid14 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 6
sid16 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 7
sid18 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 8
sid20 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
n = 9
sid22 <- c(1+n,11+n,21+n,31+n,41+n,51+n,61+n,71+n,81+n,91+n,101+n,111+n,121+n,131+n,141+n,151+n,161+n,17+n,181+n,191+n,201+n,211+n,221+n,231+n,241+n,251+n,261+n,271+n,281+n,291+n,301+n,311+n,321+n,331+n,341+n,351+n,361+n,371+n,381+n,391+n,401+n,411+n,421+n,431+n,441+n,451+n,461+n,471+n,481+n,491+n)
...
sid6 <- subset(loop, loop$Side== "6")
sid6
# sites <- as.matrix(c(16 , 36 , 64 ,100, 144, 196 ,256, 324, 400, 484))
...
loop$Lambda[c(1:10, 101:110, 201:210, 301:310, 401:410 )]
loop$Lambda[c(11:20, 111:120, 211:220, 311:320, 411:420 )]
loop$Lambda[c(21:30, 121:130, 221:230, 321:330, 421:430 )]
loop$Lambda[c(31:40, 131:140, 231:240, 331:340, 431:440 )]
loop$Lambda[c(41:50, 141:150, 241:250, 341:350, 441:450 )]
loop$Lambda[c(51:60, 151:160, 251:260, 351:360, 451:460 )]
loop$Lambda[c(61:70, 161:170, 261:270, 361:370, 461:470 )]
loop$Lambda[c(71:80, 171:180, 271:280, 371:380, 471:480 )]
loop$Lambda[c(81:90, 181:190, 281:290, 381:390, 481:490 )]
loop$Lambda[c(91:100, 191:200, 291:300, 391:400, 491:500 )]
